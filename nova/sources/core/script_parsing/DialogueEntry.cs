...
namespace Nova
{
    ...
    public class DialogueEntry
    {
        ...
        /// </summary>
        private readonly Dictionary<DialogueActionStage, ScriptFunction> actions;

        public readonly ulong textHash;

        public DialogueEntry(string characterName, string displayName, string dialogue,
            Dictionary<DialogueActionStage, ScriptFunction> actions, ulong textHash)
        {
