...
namespace Nova
{
    ...
    [Serializable]
    public class NodeChangedEvent : NovaEvent<NodeChangedData> { }
    ...
    // [Serializable]
    public class DialogueChangedEvent : NovaEvent<DialogueChangedData> { }
    ...
    [Serializable]
    public class ChoiceOccursEvent : NovaEvent<ChoiceOccursData> { }
    ...
    [Serializable]
    public class RouteEndedEvent : NovaEvent<RouteEndedData> { }
}
